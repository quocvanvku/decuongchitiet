    ...
    <div class="them-moi-de-cuong">
        ...
        <div class="row body-them-moi-de-cuong">
            ...
            <div class="col-md-10 nopadding">
				<form action="{{URL::to('admin/decuong/sua-de-cuong/'.$all_decuong->id_decuong)}}" method="post">
				{{ csrf_field() }}
					<div class="tab-body">
									...
									<tr>
										...
										<td>
											<select name="khungchuongtrinh" id="select_khoa" required="" multiple>
                                                ...
                                                <option value="{{$value_khungchuongtrinh->id}}" <?php if($all_decuong->khungchuongtrinh == $value_khungchuongtrinh->id) {echo "selected ";} ?> >{{$value_khungchuongtrinh->tenkhungchuongtrinh}}</option>
												@endforeach
											</select> 
										</td>
									</tr>
