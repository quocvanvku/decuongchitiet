...
<div class="danh-gia-hoc-phan">
	<div class="container">
		...
		<fieldset>
			<legend>Sửa đánh giá học phần <span>{{$tenhocphan->tenhocphan}}</span></legend>
			...
			<div class="row table-danh-gia-hoc-phan">
				<div class="col-md-12 nopadding">		
					...
					<h4>Sửa đánh giá học phần {{$tenhocphan->tenhocphan}} </h4>

					<form action="{{URL::to('admin/decuong/sua-danh-gia-hoc-phan/'.$id_decuong)}}" method="post">
						{{ csrf_field() }}
						...
						<div class="sm-dghp">
							<center><input type="submit" value="Sửa đánh giá học phần" class="btn btn-success submit-danh-gia-hoc-phan"></center>
						</div>
					</form>	
				</div>
			</div>
