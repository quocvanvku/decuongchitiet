...
<div class="danh-gia-hoc-phan">
	<div class="container">
		...
		<fieldset>
			<legend>Thêm đánh giá học phần <span>{{$tenhocphan->tenhocphan}}</span></legend>
					...
					<table class="table table-bordered table-striped">
						<thead>
							<tr>
								...
								<td style="text-align:left;">Chuẩn đầu ra học phần (CLO)</td>
							</tr>
						</thead>
						<tbody>
							<?php $stt=1; ?>
							...
							<tr>
								...
								<td class="row-cdr" style="text-align:left;" >{{$value_cdr->noi_dung}}</td>
							</tr>
							<?php $stt++; ?>
							@endforeach
						</tbody>
			...
			<div class="row table-danh-gia-hoc-phan">
				<div class="col-md-12 nopadding">
					...
					<h4>Thêm đánh giá học phần {{$tenhocphan->tenhocphan}} </h4>

					<form action="{{URL::to('admin/decuong/them-danh-gia-hoc-phan/'.$id_decuong)}}" method="post">
					{{ csrf_field() }}
						...
						<div class="sm-dghp">
							<center><input type="submit" value="Thêm đánh giá học phần" class="btn btn-success submit-danh-gia-hoc-phan"></center>
						</div>
