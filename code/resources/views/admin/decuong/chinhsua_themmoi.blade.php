    ...
    <div class="them-moi-de-cuong">
        ...
        <div class="row body-them-moi-de-cuong">
            ...
            <div class="col-md-10 nopadding">
				<form action="{{URL::to('admin/decuong/insert-chinh-sua-them-moi-de-cuong')}}" method="post">
				{{ csrf_field() }}
					<div class="tab-body">
						<div class="list-tab-body active">
							<div class="block">

								<input type="hidden" name="khungchuongtrinh_hientai" value="{{$khungchuongtrinhhientai}}">
								<input type="hidden" name="id_decuong_hientai" value="{{$id_decuong_hientai}}">
							...
							<div class="block">
								<table>
									...
									<tr>
										<td></td>
										<td>
											<input type="submit" name="sm_decuong" id="sm-decuong" value="Nhân bản đề cương">
										</td>
									</tr>
