            ...
            <div class="col-md-12 nopadding">
                ...
                <div id="hoatdong-nckh" class="tabcontent active">
                    ...
                    <div id="themmoi-nckh" class="tabhoatdongnckh active">
                        ...
                        <form action="{{URL::to('admin/decuong/them-moi-nghien-cuu-khoa-hoc-loai-2')}}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                ...
                                <fieldset>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" name="lachubien" id="" value="1">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Số chủ biên :</td>
                                            <td>
                                                <input type="number" name="sochubien" required="">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Năm xuất bản :</td>
