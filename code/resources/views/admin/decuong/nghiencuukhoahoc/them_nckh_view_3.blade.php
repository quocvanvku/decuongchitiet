            ...
            <div class="col-md-12 nopadding">
                ...
                <div id="hoatdong-nckh" class="tabcontent active">
                    ...
                    <div id="themmoi-nckh" class="tabhoatdongnckh active">
                        ...
                        <form action="{{URL::to('admin/decuong/them-moi-nghien-cuu-khoa-hoc-loai-3')}}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                ...
                                <fieldset>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>Minh chứng :</td>
                                            <td>
                                                <textarea name="minhchung" id="" cols="70" rows="7"></textarea>
                                            </td>
                                        </tr>
