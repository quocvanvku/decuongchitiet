...
INSERT INTO `table_chuandaura_chung` VALUES (4, 'Có năng lực ngoại ngữ tương đương TOEIC 500;', 1);
INSERT INTO `table_chuandaura_chung` VALUES (5, 'Có kiến thức cơ sở chuyên môn vững chắc để đáp ứng tốt các công việc khác nhau trong lĩnh vực rộng của ngành CNTT.', 1);
INSERT INTO `table_chuandaura_chung` VALUES (6, 'Có khả năng áp dụng kiến thức cơ bản về khoa học tự nhiên, khoa học xã hội, kiến thức toàn diện, chuyên sâu và tiên tiến về ngành CNTT để giải quyết các vấn đề phức tạp, mới trong lĩnh vực chuyên ngành, liên ngành;', 1);
...
INSERT INTO `table_chuandaura_chung` VALUES (38, 'Có khả năng nghiên cứu, đề xuất, cải tiến các hệ thống, sản phẩm, giải pháp CNTT trong bối cảnh kinh tế, xã hội và môi trường.', 1);
